...
use Note\Entity\EntityInterface;
...
abstract class AbstractMapper
{
	 ...
	 */
	protected function select($where = null, $order = null, $limit = null, $offset = null) 
	{
        if (!$this->isInitialized) {
            $this->initialize();
        }
	 ...
	 *
	 * @param NoteEntityInterface $entityPrototype
	 * @return AbstractMapper
	 */
